    ...
    return (
        <section className='px-16 mt-8'>
            ...
            <div className="contact-form flex flex-col justify-center">
                <input type="text" placeholder="Type here" class="input input-bordered input-accent w-full lg:max-w-xs" />
                <input type="text" placeholder="Type here" class="input input-bordered input-accent w-full lg:max-w-xs" />
                <textarea class="textarea textarea-accent input-borderd w-full lg:max-w-sx" placeholder="Bio"></textarea>
            </div>
        </section>
    );
};
